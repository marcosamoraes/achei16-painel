<x-app-layout>
    <x-slot name="header">
        ...
        <a href="{{ route('sellers.create') }}"><x-button>Cadastrar</x-button></a>
    </x-slot>
                    ...
                    <div class="min-w-full align-middle">
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-500 border dark:border-gray-500 mt-5">
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3 bg-gray-50 dark:bg-dark-eval-1 text-center">
                                    <span class="text-xs leading-4 font-medium text-gray-500 dark:text-white uppercase tracking-wider">CPF/RG</span>
                                </th>
                                <th class="px-6 py-3 bg-gray-50 dark:bg-dark-eval-1 text-center">
